    ...
    <div class="contatiner">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item"><a class="nav-link active" aria-current="page" href="introduce.home"><b>학교소개</b></a></li>
        ...
        <div class="row body p-5">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="#">입학정보</a>
                                </li>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9"><b class="sub">인사말<br></b></div>
            </div>
            <div class="row">
                <div class="col-3"></div>
                    <div class="col-lg-9">안녕하세요. kh대학입니다.<br><br>
                옛날 인디언 속담중에 이런말이있습니다.<br><br>
                만번을 입밖으로 말하면 그말이 이루어진다<br><br>
                무언가 간절히원하게되면 그 일이 이루어진다라는뜻인데요<br><br>
                여러분도 무언가 간절히 이루고싶은것이 있다면 만번 되내여보세요.<br><br>
                어느순간 이루어져있을겁니다.
                <br><br>
                    </div>
            </div>
