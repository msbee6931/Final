(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_reject","559","514","80","30",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("28");
            obj.set_text("반려");
            this.Div00.addChild(obj.name, obj);
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.form.btn_reject.addEventHandler("onclick",this.Div00_btn_ok_onclick,this);
