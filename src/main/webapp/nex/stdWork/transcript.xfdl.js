(function()
{
    return function()
    {
        ...
        {
        	location.href="https://pdfmyurl.com/api?license=eVNJ64pvSbol&url=http://localhost/certification/transcript";
        };


        this.absence_onload = function(obj,e)
        {
        	this.Div00.form.WebBrowser00.set_url("http://localhost/certification/transcript");
        };
