(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("alaram_btn","1126","14","61","27",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("알람");
            this.addChild(obj.name, obj);

            obj = new Edit("hidden","1126","0","151","14",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);
        ...
        this.alaram_btn_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.alaram_btn.addEventHandler("onclick",this.alaram_btn_onclick,this);
        };
